...
var militaryService = function () {
  var answer = prompt(' Do you think I served in the Navy? Answer with a Yes or No. ');
  console.log('Military Service guess', answer);
  if (answer.trim().toLowerCase() === 'yes'){
    alert('That is right ' + userNameAnswer + ' I served in the United States Navy. Next you get to guess how many years I served.  Good Luck!');
  } else {
...
var yearsServed = function () {
  var answer = prompt(' How many years do you think I served? Hint, it is between 20 and 30.');
  console.log('Years Served Guess' + answer);
  alert(' you think I did ' + answer + ' years of service. I did over 24');

  if (answer <= 23){
    alert(' Sorry, ' + userNameAnswer + ' I served over 24! ');
    return answer;
  } else {
    if(answer >= 25){
...
var age = function () {
  var answer = prompt(' Now for a more difficult question. How old do you think I am? ');
  console.log(answer);
  alert('you guessed my age as ' + answer);
